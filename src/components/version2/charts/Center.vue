<template>
  <div id="center">
    <CheckboxGroup v-model="checkAllGroup" @on-change="checkAllGroupChange" style="height: 50px;line-height: 50px">
      <Checkbox label="0" :style="{color:' rgb(41, 140, 255)'}">落后于年计划或月计划</Checkbox>
      <Checkbox label="-1" :style="{color:' rgba(226, 82, 81,0.9)'}">落后于月计划和年计划</Checkbox>
      <Checkbox label="1" :style="{color:'rgba(144,198,99,1)'}">进度超前</Checkbox>
      <Checkbox label="2" :style="{color:'rgba(0,0,0,0.8)'}">无计划</Checkbox>
    </CheckboxGroup>
    <div style="width: 100%;height: 50px;line-height: 50px;text-align: left;">
      <Row>
        <Col span="5" style="color: black;font-size: 16px">
        选择年月：
        </Col>
        <Col span="8">
